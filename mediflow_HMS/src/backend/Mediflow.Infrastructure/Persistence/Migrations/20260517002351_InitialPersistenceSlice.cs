...
{
    /// <inheritdoc />
    public partial class InitialPersistenceSlice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QueueState = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AppointmentDate_Department_DoctorName_TokenNumber",
                table: "Appointments",
                columns: new[] { "AppointmentDate", "Department", "DoctorName", "TokenNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_FullName_DateOfBirth",
                table: "Patients",
