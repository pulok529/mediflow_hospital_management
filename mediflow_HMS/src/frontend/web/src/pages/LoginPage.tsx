...
export function LoginPage() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <input className="w-full rounded-lg border px-3 py-2 focus:border-slate-700 focus:outline-none" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
      <input className="w-full rounded-lg border px-3 py-2 focus:border-slate-700 focus:outline-none" placeholder="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
